...
class Auto_Evaluation(unittest.TestCase):
    def test_Auto_Evaluation(self):
        ...
        wb = xlrd.open_workbook("/home/muttumurgan/Desktop/AutomationScripts/PythonWorkingScripts_InputData/"
                                "Assessment/Final_Test_Data.xls")
        ...
        while n < sh1.nrows:
            ...
            login_user_data = {"LoginName": "admin", "Password": "SLWS-124", "TenantAlias": "automation",
                     "UserName": "admin"}
            ...
            wb_result.save(
                "/home/muttumurgan/Desktop/AutomationScripts/PythonWorkingScripts_Output/Assessment/Final_Result_Evaluation_Check.xls")
            n += 1
            rownum += 1
