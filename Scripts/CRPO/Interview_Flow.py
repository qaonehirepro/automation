...
class InterviewFeedback:
    ...
    def __init__(self):
        ...
        for headers in excelheaders:
            if headers in ['Comparison', 'Status', 'ApplicantID', 'Schedule_Message', 'IR_id', 'Feedback_Message',
                           'Interviewer_Decision', 'Partial_Feedback', 'Partial_Feedback_message',
    ...
    def output_excel(self, loop):
        ...
        self.ws.write(self.rowsize, 2, self.applicant_details.get('applicantId'), self.__style8)
        # --------------------------------------------------------------------------------------------------------------

        if self.is_success:
            self.ws.write(self.rowsize, 3, self.feedback_data['interviewerComment'], self.__style8)
        else:
            self.ws.write(self.rowsize, 3, self.message, self.__style3)
        # --------------------------------------------------------------------------------------------------------------

        if self.ir:
            self.ws.write(self.rowsize, 4, self.ir, self.__style8)
        else:
            self.ws.write(self.rowsize, 4, None)
        # --------------------------------------------------------------------------------------------------------------

        if self.is_feedback:
            self.ws.write(self.rowsize, 5, self.feedback_message, self.__style8)
        else:
            self.ws.write(self.rowsize, 5, None)
        # --------------------------------------------------------------------------------------------------------------

        if self.feedback and self.feedback['decisionText']:
            self.ws.write(self.rowsize, 6, self.feedback['decisionText'], self.__style8)
        else:
            self.ws.write(self.rowsize, 6, None)
        # --------------------------------------------------------------------------------------------------------------

        if self.feedback and self.feedback['partialFeedback'] == 1:
            self.ws.write(self.rowsize, 7, 'True', self.__style8)
        elif self.feedback and self.feedback['partialFeedback'] == 0:
            self.ws.write(self.rowsize, 7, 'False', self.__style3)
        # -------------------------------------------------------------------------------------------------------------

        if self.partial_data.get('message'):
            self.ws.write(self.rowsize, 8, self.partial_data['message'], self.__style8)
        else:
            self.ws.write(self.rowsize, 8, None)
        # --------------------------------------------------------------------------------------------------------------
        if self.decision_update and self.decision_update.get('message'):
            self.ws.write(self.rowsize, 9, self.decision_update.get('message'), self.__style8)
        elif self.decision_error and self.decision_error.get('errorDescription'):
            self.ws.write(self.rowsize, 9, self.decision_error.get('errorDescription'), self.__style3)
        else:
            self.ws.write(self.rowsize, 9, None)
        # --------------------------------------------------------------------------------------------------------------

        # if self.decision_update and self.decision_update.get('oldStatus'):
        #     self.ws.write(self.rowsize, 9, self.decision_update.get('oldStatus'), self.__style8)
        # else:
        #     self.ws.write(self.rowsize, 9, None)
        if self.decision_updated_feedback and self.decision_updated_feedback['decisionText']:
            self.ws.write(self.rowsize, 10, self.decision_updated_feedback['decisionText'], self.__style8)
        else:
        ...
        if self.xl_Datetime[loop] == self.feedback_data.get('interviewTime'):
            if self.xl_Datetime[loop] is None:
                self.ws.write(self.rowsize, 11, 'Empty_value', self.__style6)
            else:
                self.ws.write(self.rowsize, 11, self.feedback_data.get('interviewTime'))
        else:
            self.ws.write(self.rowsize, 11, self.feedback_data.get('interviewTime'))
        # --------------------------------------------------------------------------------------------------------------
        ...
        if self.is_feedback:
            if self.xl_int_datetime[loop] == self.feedback.get('interviewedTime'):
                if self.xl_int_datetime[loop] is None:
                    self.ws.write(self.rowsize, 12, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 12, self.feedback.get('interviewedTime'))
            else:
                self.ws.write(self.rowsize, 12, self.feedback.get('interviewedTime'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Skill_id_01[loop] == self.skill_dict_1.get('skillId'):
                if self.xl_Skill_id_01[loop] is None:
                    self.ws.write(self.rowsize, 13, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 13, self.skill_dict_1.get('skillId'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Skill_score_01[loop] == self.skill_dict_1.get('skillScore'):
                if self.xl_Skill_score_01[loop] is None:
                    self.ws.write(self.rowsize, 14, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 14, self.skill_dict_1.get('skillScore'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Skill_id_02[loop] == self.skill_dict_2.get('skillId'):
                if self.xl_Skill_id_02[loop] is None:
                    self.ws.write(self.rowsize, 15, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 15, self.skill_dict_2.get('skillId'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Skill_score_02[loop] == self.skill_dict_2.get('skillScore'):
                if self.xl_Skill_score_02[loop] is None:
                    self.ws.write(self.rowsize, 16, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 16, self.skill_dict_2.get('skillScore'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Skill_id_03[loop] == self.skill_dict_3.get('skillId'):
                if self.xl_Skill_id_03[loop] is None:
                    self.ws.write(self.rowsize, 17, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 17, self.skill_dict_3.get('skillId'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Skill_score_03[loop] == self.skill_dict_3.get('skillScore'):
                if self.xl_Skill_score_03[loop] is None:
                    self.ws.write(self.rowsize, 18, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 18, self.skill_dict_3.get('skillScore'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Skill_id_04[loop] == self.skill_dict_4.get('skillId'):
                if self.xl_Skill_id_04[loop] is None:
                    self.ws.write(self.rowsize, 19, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 19, self.skill_dict_4.get('skillId'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Skill_score_04[loop] == self.skill_dict_4.get('skillScore'):
                if self.xl_Skill_score_04[loop] is None:
                    self.ws.write(self.rowsize, 20, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 20, self.skill_dict_4.get('skillScore'))
        else:
        ...
        if self.is_feedback:
            if self.xl_duration[loop] == self.feedback.get('duration'):
                if self.xl_duration[loop] is None:
                    self.ws.write(self.rowsize, 21, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 21, self.feedback.get('duration'))
        else:
        ...
        if self.is_feedback:
            if self.xl_skill_comment[loop] == self.skill_dict_4.get('skillComment'):
                if self.xl_Skill_score_04[loop] is None:
                    self.ws.write(self.rowsize, 22, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 22, self.skill_dict_4.get('skillComment'))
        else:
        ...
        if self.is_feedback:
            if self.xl_Over_all_comment[loop] == self.feedback.get('comment'):
                if self.xl_Over_all_comment[loop] is None:
                    self.ws.write(self.rowsize, 23, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 23, self.feedback.get('comment'))
        else:
            self.ws.write(self.rowsize, 23, None)
        # --------------------------------------------------------------------------------------------------------------
        ...
        if self.xl_partial_feedback[loop] == 1 or self.xl_partial_feedback[loop] == 0:
            if self.xl_update_skill_score_01[loop] == self.updated_skill_dict_1.get('skillScore'):
                if self.xl_update_skill_score_01[loop] is None:
                    self.ws.write(self.rowsize, 24, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 24, self.updated_skill_dict_1.get('skillScore'))
            elif self.xl_partial_feedback[loop] == 1:
                if self.feedback_message:
                    self.ws.write(self.rowsize, 24, self.updated_skill_dict_1.get('skillScore', 'No_Update_Details'),
                                  self.__style6)
                else:
                    self.ws.write(self.rowsize, 24, self.updated_skill_dict_1.get('skillScore', 'NA'), self.__style3)
        ...
        if self.xl_partial_feedback[loop] == 1 or self.xl_partial_feedback[loop] == 0:
            if self.xl_updated_duration[loop] == self.updated_feedback.get('duration'):
                if self.xl_updated_duration[loop] is None:
                    self.ws.write(self.rowsize, 25, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 25, self.updated_feedback.get('duration'))
            elif self.xl_partial_feedback[loop] == 1:
                if self.feedback_message:
                    self.ws.write(self.rowsize, 25, self.updated_feedback.get('duration', 'No_Update_Details'),
                                  self.__style6)
                else:
                    self.ws.write(self.rowsize, 25, self.updated_feedback.get('duration', 'NA'), self.__style3)
            elif self.xl_partial_feedback[loop] == 0:
                if self.feedback_message:
        ...
        if self.xl_partial_feedback[loop] == 1 or self.xl_partial_feedback[loop] == 0:
            if self.xl_update_Skill_comment[loop] == self.updated_skill_dict_4.get('skillComment'):
                if self.xl_update_Skill_comment[loop] is None:
                    self.ws.write(self.rowsize, 26, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 26, self.updated_skill_dict_4.get('skillComment'))
            elif self.xl_partial_feedback[loop] == 1:
                if self.feedback_message:
                    self.ws.write(self.rowsize, 26, self.updated_skill_dict_4.get('skillComment', 'No_Update_Details'),
                                  self.__style6)
                else:
                    self.ws.write(self.rowsize, 26, self.updated_skill_dict_4.get('skillComment', 'NA'), self.__style3)
            elif self.xl_partial_feedback[loop] == 0:
                if self.feedback_message:
        ...
        if self.xl_partial_feedback[loop] == 1 or self.xl_partial_feedback[loop] == 0:
            if self.xl_Updated_Over_all_comment[loop] == self.updated_feedback.get('comment'):
                if self.xl_Updated_Over_all_comment[loop] is None:
                    self.ws.write(self.rowsize, 27, 'Empty_value', self.__style6)
                else:
                    self.ws.write(self.rowsize, 27, self.updated_feedback.get('comment'))
            elif self.xl_partial_feedback[loop] == 1:
                if self.feedback_message:
                    self.ws.write(self.rowsize, 27, self.updated_feedback.get('comment', 'No_Update_Details'),
                                  self.__style6)
                else:
                    self.ws.write(self.rowsize, 27, self.updated_feedback.get('comment', 'NA'), self.__style3)
            elif self.xl_partial_feedback[loop] == 0:
                if self.feedback_message:
