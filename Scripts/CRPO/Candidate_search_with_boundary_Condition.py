...
class Excel_Data:
    ...
    # ------------------------------------------------------------------------------------------------------------------
        wb = xlrd.open_workbook('/home/muthumurugan/Desktop/Automation/'
                                'PythonWorkingScripts_InputData/CRPO/Candidate/'
    ...
    def all(self):
        ...
        for i in range(0,tot_len):
            ...
            if self.total_api_count == self.Query_Result1:
                ...
                # self.ws.write(self.rownum, 5, self.query, self.__style3)
                ...
                # self.ws.write(self.rownum, 5, self.query, self.__style2)
                print self.query
            else:
                ...
                print self.query
            self.wb_result.save(
                '/home/muthumurugan/Desktop/Automation/PythonWorkingScripts_Output/CRPO/CandidateSearch/'
                + self.__current_DateTime + '_Candidate_Search_With_Boundary.xls')
            # print statusCode, " -- ", b
    ...
    def Query_Generation(self):
        ...
        if self.xl_request.get("CreatedFrom") and self.xl_request.get("CreatedTo"):
            created_on_from = xlob.date_converter(self.xl_request.get("CreatedFrom"))
            created_on_to = xlob.date_converter(self.xl_request.get("CreatedTo"))
        ...
        if self.xl_request.get("ModifiedFrom") and self.xl_request.get("ModifiedTo"):
            modefied_on_from = xlob.date_converter(self.xl_request.get("ModifiedFrom"))
            modefied_on_to = xlob.date_converter(self.xl_request.get("ModifiedTo"))
