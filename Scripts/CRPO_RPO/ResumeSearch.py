...
class Excel_Data:
    ...
    def __init__(self):
        ...
        wb = xlrd.open_workbook('/home/muthumurugan/Desktop/Automation/PythonWorkingScripts_InputData/CRPO-RPO/'
                                'Search/ResumeSerachInput.xls')
    ...
    def all(self):
        ...
        for i in range(0, tot_len):
            ...
            self.wb_result.save(
                '/home/muthumurugan/Desktop/Automation/PythonWorkingScripts_Output/CRPO_RPO/Search/'
