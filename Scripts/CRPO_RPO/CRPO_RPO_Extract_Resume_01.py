...
class extractResume(unittest.TestCase):
    def test_extractResume(self):
        ...
        wb = xlrd.open_workbook("/home/muthumurugan/Desktop/Automation/PythonWorkingScripts_InputData/"
                                "CRPO-RPO/Extractor/ExtractResumeNew001.xls")
        ...
        while i < sh1.nrows:
            ...
            # time.sleep(5)
            wb_result.save(
                '/home/muthumurugan/Desktop/Automation/PythonWorkingScripts_Output/CRPO_RPO/Extractor/'
                'ExtractResumeResult(' + __current_DateTime + ').xls')
