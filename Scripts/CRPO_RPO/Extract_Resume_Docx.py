...
from AllConstants import CONSTANT
...
class extractResume(unittest.TestCase):
    def test_extractResume(self):
        ...
        wb = xlrd.open_workbook("/home/muttumurgan/Desktop/AutomationScripts/PythonWorkingScripts_InputData/"
                                "CRPO-RPO/Extractor/ExtractResumeDocxInput.xls")
        ...
        while i < sh1.nrows:
            ...
            # print CONSTANT.RESUME_FILE_PATH_DOCX + rows[0]+'.doc'
            # print __attach_Resume.send_keys(CONSTANT.RESUME_FILE_PATH_DOCX + rows[0] + '.doc')
            # time.sleep(1)
            __attach_Resume.send_keys(CONSTANT.RESUME_FILE_PATH_DOCX + rows[0])
            time.sleep(5)
            ...
            # time.sleep(5)
            wb_result.save(
                '/home/muttumurgan/Desktop/AutomationScripts/PythonWorkingScripts_Output/CRPO_RPO/'
                'Extractor/ExtractResumeResultDOCX(' + __current_DateTime + ').xls')
            # print __msg_Content
