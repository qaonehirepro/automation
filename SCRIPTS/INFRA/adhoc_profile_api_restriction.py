...
class IsStrictValidations:
    ...
    def domain_validations(self, admin_token, adhoc_token, xl_data):
...
at_adhoc_token = crpo_common_obj.login_to_crpo(amsin_at_adhoc_profile.get('user'),
                                               amsin_at_adhoc_profile.get('password'),
                                               amsin_at_adhoc_profile.get('tenant'))
# print(at_adhoc_token)
...
for current_excel_data in excel_data:
    validation_obj.domain_validations(at_admin_token, at_adhoc_token, current_excel_data)
