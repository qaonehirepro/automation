...
class DeleteQuestionStatistics:
    ...
    def delete_question_statistics(self):
        ...
        question_statistics = "delete from question_statisticss where id in " \
                              ...
                              "where id in (132829,132837,132839,132833,132835,132843,132845,132841,132847,132849,132851) and tenant_id in (1));"
        self.cursor.execute(question_statistics)
        self.conn.commit()

        tuser_results = "update test_results set is_statistics_completed = 0 " \
                        "where question_id in (132829,132837,132839,132833,132835,132843,132845,132841,132847,132849,132851) and question_tenant_id in (1);"
