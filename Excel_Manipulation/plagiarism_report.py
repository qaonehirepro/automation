import ast
from Excel_Manipulation.plagiarism_report_config import *
...
class PlagiarismReport:
    ...
    def downloadReport(self, token):
        print(token)
        resp_dict = crpo_common_obj.generate_plagiarism_report(token, config_obj.getall_plagarism_data)
        print(resp_dict)
...
air = PlagiarismReport()
total_jobs_count = config_obj.total_jobs.values()
crpo_headers = crpo_common_obj.login_to_crpo(cred_crpo_admin_at.get('user'), cred_crpo_admin_at.get('password'),
