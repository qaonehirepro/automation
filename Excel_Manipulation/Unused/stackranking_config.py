...
class AllConfigurations:
    ...
    def filePath(self, date):
        self.expected_excel_sheet_path = '/home/muthumurugan/Desktop/Automation/PythonWorkingScripts_InputData/CRPO/' \
                                         'stackranking/stack_ranking_FourEvents_report.xlsx'

        self.download_path = '/home/muthumurugan/Desktop/Automation/PythonWorkingScripts_Output/CRPO/stackranking/' \
                             'stackranking_%s.xlsx' % date

        self.save_path = '/home/muthumurugan/Desktop/Automation/PythonWorkingScripts_Output/CRPO/stackranking/' \
                         'stackranking_final%s.xlsx' % date
