import subprocess
from Unused.stackranking_config import *
...
try:
    ...
    write_excel_object.excelWriteHeaders(hierarchy_headers_count=2)
    write_excel_object.excelMatchValues(usecase_name=' Stack Ranking Report ', comparision_required_from_index=2,
